...
import { MapPin, Certificate, Book } from '@phosphor-icons/react'; // Ikon Admin
import AdminLayout from '../../../components/adminlayout'; // Asumsi layout admin
...
export default function AdminBerandaPage() {
    ...
    const submissionData: SubmissionItem[] = [
        ...
        { id: 4, namaUsaha: "Toko Sembako Maju", emailPemohon: "maju@mail.com", tanggal: "16/11/2025", status: 'Diterima' },
        { id: 5, namaUsaha: "Jasa Servis Mobil", emailPemohon: "servis@mail.com", tanggal: "15/11/2025", status: 'Ditolak' },
    ];
            ...
            <div className="space-y-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
                    ...
                    <div className="lg:col-span-2">
                        <SubmissionWidget submissions={submissionData.slice(0, 4)} />
                    </div>
                </div>
            </div>
        </AdminLayout>
