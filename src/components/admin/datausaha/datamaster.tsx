...
const DUMMY_LOCATIONS: LocationMaster[] = [
    { id: 1, koordinat: [-6.745, 108.557], status: 'Terisi', umkmName: 'Warung Kopi Senja' },
    { id: 2, koordinat: [-6.750, 108.560], status: 'Tersedia', umkmName: '' },
    { id: 3, koordinat: [-6.740, 108.555], status: 'Terlarang', umkmName: 'Zona Merah' },
    { id: 4, koordinat: [-6.748, 108.559], status: 'Terisi', umkmName: 'Toko Sembako Maju' },
];
