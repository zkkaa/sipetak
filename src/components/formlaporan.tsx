...
import { Camera, MapPin, ShieldWarning, PaperPlaneTilt } from '@phosphor-icons/react'; // Ikon
            ...
            <div className="container mx-auto px-6 max-w-5xl">
                ...
                <header className="text-center mb-12">
                    ...
                    <p className="text-md text-gray-600 mt-2 max-w-2xl mx-auto">
                        Bantu wujudkan kota tertib dan nyaman. Laporan Anda bersifat **anonim** dan prosesnya **cepat**. Tidak perlu login.
                    </p>
                </header>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10 bg-white p-6 md:p-10 rounded-xl shadow-lg">
                    ...
                    <form onSubmit={handleSubmit} className="md:col-span-2">
                        ...
                        <InputContainer 
                            ...
                            description="Foto harus jelas menunjukkan pelanggaran (misal: penempatan di trotoar)."
                        >
                            <label className="flex items-center justify-center border-2 border-dashed border-gray-300 rounded-lg p-4 cursor-pointer hover:bg-gray-50 transition duration-150 h-56">
                                ...
                                {previewUrl ? (
                                    ...
                                    <div className="flex flex-col items-center text-center text-gray-700">
                                        ...
                                        <span>
                                            {formData.photoFile ? formData.photoFile.name : "Klik di sini untuk unggah foto"}
                                        </span>
                                    </div>
                                )}
                            </label>
                        ...
                        <InputContainer 
                            ...
                            description="Otomatis mengambil koordinat GPS (Geolocation) dari ponsel/perangkat Anda."
                        >
                            <div className="flex flex-col gap-2">
                                <Button 
                                    ...
                                    type="button" 
                                >
                                    <MapPin size={20} className="mr-2 inline" /> Ambil Lokasi Saat Ini
                                </Button>
                    ...
                    <aside className="md:col-span-1 bg-gray-50 p-6 rounded-lg self-stretch flex flex-col justify-between">
                        <div>
                            ...
                            <ol className="space-y-4 text-gray-700">
                                ...
                                <li><span className="font-bold text-lg mr-2">2.</span> Klik **Ambil Lokasi** untuk mendapatkan koordinat yang akurat.</li>
                                <li><span className="font-bold text-lg mr-2">3.</span> Isi deskripsi singkat dan **Kirim Laporan**.</li>
                            </ol>
                        ...
                        <div className="mt-8 bg-gray-200 h-40 rounded-lg flex items-center justify-center text-gray-500">
                            [Placeholder Peta Interaktif]
                        </div>
                    </aside>
                </div>
            </div>
